...
<section>
  ...
  <?php
  $sql = "SELECT *,seller_notes.id AS id , AVG(rating) AS avgratings FROM seller_notes LEFT JOIN seller_notes_reviews ON seller_notes_reviews.note_id = seller_notes.id WHERE status = 9";

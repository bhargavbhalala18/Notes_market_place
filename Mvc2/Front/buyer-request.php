                                        ...
                                        <td>
                                            <div class="dropdown dropleft">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-left" aria-labelledby="dropdownMenuLink1">
                                                    ...
                                                    <a class="dropdown-item" href="#exampleModalCenter" data-toggle="modal">Add Reviws/Feedback</a>
                                                    <div id="add-review-popup"></div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown dropleft">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-left" aria-labelledby="dropdownMenuLink1">
                                                    <a class="dropdown-item" href="#">Download Note</a>
                                                    <a class="dropdown-item" href="#">Add Reviws/Feedback</a>
                                                    <a class="dropdown-item" href="#">Report as Inappropriate</a>
                                                </div>
                                            </div>
                                        </td>

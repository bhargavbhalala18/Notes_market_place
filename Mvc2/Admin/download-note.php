        ...
        <div class="content-box-first">
            <div class="container table-caption-header">
                <div class="row">
                    ...
                    <div class="col-md-5 col-sm-6 table-caption-drop wow zoomIn" style="padding: 0;">
                        <label for="note">note
                    ...
                    <div class="col-md-5 table-cap-right wow slideInRight">
                        <form>
                            <div class="row">
                            ...
                            <table class="table">
                                <thead class="text-center">
                                    <tr>
                                        ...
                                        <th scope="col" style="width: 105px;">BUYER</th>
                                        <th scope="col"></th>
                                        <th scope="col" style="width: 110px;">SELLER</th>
                                        <th scope="col"></th>

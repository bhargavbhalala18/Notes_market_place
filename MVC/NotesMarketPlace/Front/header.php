                ...
                <div class="nav-option">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav text-center">
                            ...
                            <li><a href="add-note-page.html">Sell Your Notes</a></li>
                            ...
                            <li>
                                <div class="dropdown user-photo">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <a class="dropdown-item" href="my-download-page.html">My Downloads</a>
                                        ...
                                        <a class="dropdown-item" href="changePassword-page.html">Change Password</a>
                            ...
                            <li>
                                <a class="nav-btn" href="login-page.html" role="button">Logout</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div id="mobile-nav">
                    ...
                    <div id="mobile-nav-content">
                        <ul class="nav navbar-nav text-left">
                            <li><a href="search.html">Search Notes</a></li>
                            <li><a class="nav-link" href="add-note-page.html">Sell Your Notes</a></li>
                            <li><a href="faq.html">FAQ</a></li>
                            <li><a href="contact-us.html">Contact Us</a></li>
                            <li>
                                <div class="dropdown user-photo">
